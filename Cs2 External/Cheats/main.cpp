...
#include <Memory/Handle_hijack.h>
#include <Globals/hGlobals.h>
#include <Menu/ImGuiResourceLoader.h>
#include <Menu/Interfaces.h>
#include <Hacks/Hacks.h>
#include <Functions/hConsole.h>
#include <Hacks/Utils/Threads.h>
#include <Updater/Updater.h>
#include <Json/Json.hpp>

HANDLE Memory::ProcessHandle = HIJACKER::HijackExistingHandle(CS2::procID);
...
INT APIENTRY WinMain(HINSTANCE instance, HINSTANCE, PSTR, INT cmd_show)
{
	...
	cout << "  Last Updated 8th October 2024\n";
	...
	ImGui_Resource_Loader::LoadStyles(); // Change Fonts Path to Yours In the Imgui Resource Loader in Menu Folder

	updater.UpdateOffsets(); // Updating Offsets Before Running Cheats;
	...
	// Disabling Written Booleans On Exit;
	if (!Flags::isRunning)
	{
