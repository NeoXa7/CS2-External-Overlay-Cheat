...
private:
	...
	public:
		void GetMiscElements()
		{
			...
			C_Elements::Checkbox("No Sky", &Flags::enableNoSky);
			C_Elements::Checkbox("No Spread", &Flags::enableNoSpread);
			C_Elements::Checkbox("Enable Third-Person-Perspective", &Flags::enableTPV);
			C_Elements::Checkbox("Enable Map-View", &Flags::enableMapView);
			C_Elements::Checkbox("Fov Changer", &Flags::enableFovChanger);
			if(Flags::enableFovChanger)
				ImGui::SliderInt("Field-of-View", &Config::Fov::Default, 58, 140);
		}
	...
	public:
		void GetPlayerEspElements()
		{
			...
			if (Flags::enablePlayerEsp)
			{
				...
				C_Elements::ComboBox("Box Dimension",
