...
void SaveConfig(const std::string& filename)
{
    ...
    ImColor C4_Box_Color = Config::Esp::C4_Box_Color; // Default white;
    ImColor C4_Status_Text_Color = Config::Esp::C4_Status_Text_Color; // Default white;
    ...
    // Esp colors
    jsonConfig["Esp"]["BoxColor"] = colorToJson(Config::Esp::BoxColor);
    ...
    jsonConfig["Esp"]["C4_Box_Color"] = colorToJson(Config::Esp::C4_Box_Color);
    jsonConfig["Esp"]["C4_Status_Text_Color"] = colorToJson(Config::Esp::C4_Status_Text_Color);
...
void LoadConfig(const std::string& filename)
{
    ...
    if (Data.contains("Esp")) {
        ...
        Config::Esp::BoxColor = jsonToColor(Esp["BoxColor"]);
        ...
        Config::Esp::C4_Box_Color = jsonToColor(Esp["C4_Box_Color"]);
        Config::Esp::C4_Status_Text_Color = jsonToColor(Esp["C4_Status_Text_Color"]);
