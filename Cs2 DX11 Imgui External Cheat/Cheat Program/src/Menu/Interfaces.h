...
private:
	...
	public:
		void GetVisualElements()
		{
			...
			if (Flags::enableEsp)
			{
				...
				C_Elements::Checkbox("Lines", &Config::Esp::enableEspLines);
				C_Elements::Checkbox("Health Bar", &Config::Esp::enableEspHealthBar);
				C_Elements::Checkbox("Team Esp", &Config::Esp::enableEspTeam);
				ImGui::ColorEdit4("Box Color", (float*)&Config::Esp::BoxColor);
				ImGui::ColorEdit4("Lines Color", (float*)&Config::Esp::LinesColor);
				//ImGui::ColorEdit4("Health Bar Color", (float*)&Config::Esp::HealthBarColor);
	...
	public:
		...
		void GetPlayerInfoElements()
		{
			ImVec4 TerroristColor = ImVec4(234.0f / 255.0f, 209.0f / 255.0f, 139.0f / 255.0f, 255.0f / 255.0f);
			ImVec4 CounterTerroristColor = ImVec4(182.0f / 255.0f, 212.0f / 255.0f, 238.0f / 255.0f, 255.0f / 255.0f);;
			ImVec4 SpectatorColor = ImVec4(255.0f / 255.0f, 255.0f / 255.0f, 0.0f / 255.0f, 255.0f / 255.0f);

			switch (player.Team)
			{
			case 1: ImGui::TextColored(SpectatorColor, "Team : Spectator "); break;
			case 2: ImGui::TextColored(TerroristColor, "Team : Terrorist "); break;
			case 3: ImGui::TextColored(CounterTerroristColor, "Team : Counter-Terrorist "); break;
